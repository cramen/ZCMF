...
INSERT INTO `menu` VALUES (1,1,'Главная','/'),(2,2,'О компании','/page/about');
...
INSERT INTO `z_config` VALUES (6,'2010-04-20 13:16:04','Копирайты','copy','string','© 2010-2011 Cramen'),(13,'2010-05-15 11:13:48','Текст ошибки','error_text','html','<p><strong>Страница, которую вы читаете, не существует.</strong></p>\r\n<p>Если вы считаете, что мы завели вас сюда специально, опубликовав неверную ссылку, сообщите об этом&nbsp;нам.</p>'),(16,'2010-05-31 11:09:16','Счетчик','counter','text',''),(18,'2010-06-01 13:26:25','E-Mail администратора','mail','string',''),(19,'2011-03-03 09:47:56','robots.txt','robots.txt','text','User-agent:*\r\nDisallow: /redirect*\r\nDisallow: /captcha*\r\n\r\nUser-agent: Yandex\r\nDisallow: /redirect*\r\nDisallow: /captcha*\r\n');
...
INSERT INTO `z_dbtables_fields` VALUES (1,1,1,'orderid','int',11,'no','',0,1),(2,1,2,'title','varchar',255,'no','',0,0),(3,1,3,'url','varchar',255,'no','',0,0);
...
-- Dump completed on 2011-03-09 16:52:25
