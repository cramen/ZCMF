...
class Z_Cache
{
    ...
    {
        $config = Zend_Registry::get('config')->site->cache;
        $backendClass = $config->get("backendClass", 'File');

        $frontEndOptions = array(
                    'caching' => $config->get('on', false),
                    'lifetime' => $config->get('life_time', 60),
                    'cache_id_prefix' => SITE_PATH,
        //            'logging' => false,
        ...
        $oCache = Zend_Cache::factory(new Z_Cache_Core($frontEndOptions),$backendClass, $frontEndOptions, $config->options->toArray());
