...
INSERT INTO `news_themes` VALUES (1,2,'Новинки','','Novinki');
INSERT INTO `news_themes` VALUES (2,1,'Новости сайта','','Novosti_sajta');
INSERT INTO `news_themes` VALUES (3,3,'В мире','','V_mire');
...
INSERT INTO `z_dbtables_fields` VALUES (95,14,93,'sid','varchar',512,'no','',0,1);
INSERT INTO `z_dbtables_fields` VALUES (96,13,94,'sid','varchar',255,'no','',0,1);
...
--
-- Table structure for table `z_nocache_pages`
--

DROP TABLE IF EXISTS `z_nocache_pages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `z_nocache_pages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sid` varchar(255) NOT NULL,
  `code` text NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `z_nocache_pages`
--

LOCK TABLES `z_nocache_pages` WRITE;
/*!40000 ALTER TABLE `z_nocache_pages` DISABLE KEYS */;
INSERT INTO `z_nocache_pages` VALUES (1,'feedback','return array(\'controller\'=>\'feedback\');');
INSERT INTO `z_nocache_pages` VALUES (3,'search','return array(\'controller\'=>\'search\');');
/*!40000 ALTER TABLE `z_nocache_pages` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `z_resources` (
  ...
  `gen_sid_fields` varchar(255) NOT NULL,
...
INSERT INTO `z_resources` VALUES (21,'z_statpage','list',53,57,'Публикации','Z_Model_Statpage','band','sid;title;text','title','','title;sid','title','',15,1,1,1,1,0,0,'bottom',1,1);
...
INSERT INTO `z_resources` VALUES (92,'news','list',90,91,'Новости','Site_Model_News','band','id;title;description;text','title','','title;sid','date desc; id desc','',15,1,1,1,1,0,0,'bottom',1,1);
...
INSERT INTO `z_resources` VALUES (96,'z_nocachepages','list',23,95,'Настройки кэширования','Z_Model_Nocachepages','band','','sid','','','id','',15,1,1,1,1,0,0,'bottom',1,1);
...
INSERT INTO `z_resources_forms` VALUES (44,12,47,'text','order','Сортировка',0,'id','<p>Список полей для сортировки, разделяемый символом \";\"</p>',0,'',0);
INSERT INTO `z_resources_forms` VALUES (45,12,48,'text','group','Группировка',0,'','',0,'',0);
INSERT INTO `z_resources_forms` VALUES (46,12,49,'text','paginate','Постраничность',1,'15','',0,'',0);
INSERT INTO `z_resources_forms` VALUES (47,12,50,'Checkbox','can_delete','Разрешить удалять?',0,'1','',0,'',0);
INSERT INTO `z_resources_forms` VALUES (48,12,51,'Checkbox','can_edit','Разрешить редактировать?',0,'1','',0,'',0);
INSERT INTO `z_resources_forms` VALUES (49,12,52,'Checkbox','can_add','Разрешить добавлять?',0,'1','',0,'',0);
INSERT INTO `z_resources_forms` VALUES (50,12,53,'Checkbox','delete_confirm','Подтверждение удаления?',0,'1','',0,'',0);
INSERT INTO `z_resources_forms` VALUES (51,12,54,'Checkbox','delete_on_have_child','Удалять при наличии детей?',0,'0','',0,'',0);
INSERT INTO `z_resources_forms` VALUES (52,12,96,'Checkbox','sortable','Сортируемый?',0,'0','',0,'',0);
INSERT INTO `z_resources_forms` VALUES (53,12,174,'Select','sortable_position','Позиция при добавлении',0,'','Работает только в сортируемых каталогах и списках',0,'',0);
...
INSERT INTO `z_resources_forms` VALUES (179,96,172,'Text','sid','Идентификатор',1,'','',0,'',1);
INSERT INTO `z_resources_forms` VALUES (180,96,173,'CodeMirror','code','Код',1,'','<p>массив соответствий между названием параметра и значением</p>',0,'',1);
INSERT INTO `z_resources_forms` VALUES (181,12,46,'Text','gen_sid_fields','Поля для генерации строкового идентификатора (sid)',0,'','<p>через ; два поля - источник и цель. например title;sid</p>',0,'',1);
...
-- Dump completed on 2012-02-26 23:38:55
