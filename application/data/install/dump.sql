...
INSERT INTO `z_dbtables` VALUES (1,'news'),(5,'z_spam_mails'),(6,'z_spam_сategories'),(7,'z_spam_subscribers'),(8,'z_spam_refer'),(10,'menu');
...
INSERT INTO `z_dbtables_fields` VALUES (2,1,3,'date','int',0,'CURRENT_TIMESTAMP','',0,1),(3,1,4,'title','varchar',255,'no','',0,0),(5,1,5,'pic','int',11,'asdefine','0',0,0),(6,1,6,'description','text',0,'no','',0,0),(7,1,19,'text','text',0,'no','',0,0),(8,5,7,'created_on','timestamp',0,'CURRENT_TIMESTAMP','',0,1),(9,5,8,'title','varchar',255,'no','',0,1),(10,5,9,'text','text',0,'no','',0,0),(11,6,10,'title','varchar',255,'no','',0,0),(12,7,11,'created_on','timestamp',0,'CURRENT_TIMESTAMP','',0,1),(13,7,12,'fio','varchar',512,'no','',0,0),(15,7,13,'login','varchar',255,'no','',0,1),(16,7,16,'unsubscribe','varchar',255,'no','',0,1),(17,7,15,'info','text',0,'no','',0,0),(18,7,14,'email','varchar',255,'no','',0,0),(19,8,17,'rubric_id','int',11,'no','',0,1),(20,8,18,'subscriber_id','int',11,'no','',0,1),(21,1,2,'created_on','timestamp',0,'CURRENT_TIMESTAMP','',0,1),(22,5,20,'email_from','varchar',255,'no','',0,0),(26,10,25,'title','varchar',255,'no','',0,0),(27,10,26,'url','varchar',255,'no','',0,0),(28,10,24,'orderid','int',11,'no','',0,0);
...
INSERT INTO `z_privileges` VALUES (1,'add','Добавление'),(2,'edit','Редактирование'),(3,'delete','Удаление'),(4,'list','Просмотр'),(6,'reorder','Перемещение'),(7,'','Все');
...
-- Dump completed on 2010-11-26  5:47:03
